<footer class="footer footer-color non-after text-center">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="contact-form">
                        <div class="section-header">
                            ...
                            <h2 class="first-title primary-title">Contact Us</h2>
                        </div>
                        <form method="post" action="/contact#ContactForm" id="ContactForm" accept-charset="UTF-8"
                            class="contact-form">
                            <div class="contact-fields">
                                <div class="field">
                                    <input class="field-input" autocomplete="name" type="text" id="ContactForm-name"
                                        name="contact[Name]" value="" placeholder=" ">
                                    <label class="field-label" for="ContactForm-name">Name</label>
                                </div>
                                <div class="field">
                                    <input autocomplete="email" type="email" id="ContactForm-email"
                                        class="field-input " name="contact[email]" spellcheck="false"
                                        autocapitalize="off" value="" aria-required="true" placeholder=" ">
                                    <label class="field-label " for="ContactForm-email">Email <span
                                            aria-hidden="true">*</span></label>
                                </div>
                            </div>
                            <div class="field">
                                <input type="tel" id="ContactForm-phone" class="field-input" autocomplete="tel"
                                    name="contact[Phone number]" pattern="[0-9\-]*" value="" placeholder=" ">
                                <label class="field-label" for="ContactForm-phone">Phone number</label>
                            </div>
                            <div class="field">
                                <textarea rows="10" id="ContactForm-body" class="text-area field-input" name="contact[Your Message]"
                                    placeholder=" "></textarea>
                                <label class="form__label field-label" for="ContactForm-body">Your Message</label>
                            </div>
                            <div class="btn">
                                <button type="submit">
                                    SEND MESSAGE
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="footer-newsletter">
                        <div class="section-header">
                            <h1 class="sub-title">SUBSCRIBE </h1>
                            <h2 class="first-title primary-title">Newsletter</h2>
                        </div>
                        <div class="newsletter-text">
                            ...
                            <p class="newsletter-desc">Enter your email address and recived news.</p>
                        </div>
                        <form class="newsletter-form" method="post" action="/contact#ContactFooter" id="ContactFooter"
                            accept-charset="UTF-8">
                            <div class="field">
                                <input id="NewsletterForm--footer" type="email" name="contact[email]"
                                    class="field-input" value="" aria-required="true" autocorrect="off"
                                    autocapitalize="off" autocomplete="email" placeholder=" " required="">
                        ...
                        <div class="footer-social">
                            <ul class="social-list list-unstyled" role="list">
            ...
            <div class="row">
                ...
                <div class="footer-left col-lg-6 col-md-12 col-sm-12">
                    <div class="footer-copyright">
                        © 2022, Glamour Sectioned Shopify Theme Powered by Shopify
                    </div>
                </div>
...
<a id="slidetop" href="#top" title="top" style="display: block;">
